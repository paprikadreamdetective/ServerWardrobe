...
import Register_username from './pages/Register_username';
import Login_username from './pages/Login_username';
    ...
    <IonReactRouter>
      <IonTabs className='tabs'>
        <IonRouterOutlet>
          ...
          <Route exact path="/login_username">
           <Login_username/> 
          </Route>
          <Route exact path="/register_username">
           <Register_username/> 
          </Route>
