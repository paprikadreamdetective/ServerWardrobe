...
import './Login_username.css';
import logo from '../assets/wardrobe.svg'
import google from '../assets/google-logo.svg'


import User_input from '../components/mail-component';

const Login_username: React.FC = () => {
  return (
    <IonPage>
      {/* <IonHeader>
        <IonToolbar>
      ...
      <IonContent class='Container'>
        ...
        <div className="title-content">
            <h1 className='title-home'>Welcome Back_u!</h1>
        </div>
        ...
        <div className="social-media">
          ...
          <div className="container-logos">
            <IonButton fill="outline" routerLink='/register' className='social-media'>
